...
- [[dispose]](s.child.ChildProcessWithoutNullStreams.md#[dispose])
- [[captureRejectionSymbol]](s.child.ChildProcessWithoutNullStreams.md#[capturerejectionsymbol])
...
▸ **removeListener**<`K`\>(`eventName`, `listener`): [`ChildProcessWithoutNullStreams`](s.child.ChildProcessWithoutNullStreams.md)
...
▸ **off**<`K`\>(`eventName`, `listener`): [`ChildProcessWithoutNullStreams`](s.child.ChildProcessWithoutNullStreams.md)
