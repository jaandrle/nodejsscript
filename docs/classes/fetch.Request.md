[nodejsscript](../README.md) / [fetch](../modules/fetch.md) / Request

# Class: Request

[fetch](../modules/fetch.md).Request
...
| Name | Type |
| :------ | :------ |
| `input` | [`RequestInfo`](../modules/fetch.md#requestinfo) |
...
• `Readonly` **redirect**: [`RequestRedirect`](../modules/fetch.md#requestredirect)
...
• `Readonly` **referrerPolicy**: [`ReferrerPolicy`](../modules/fetch.md#referrerpolicy)
