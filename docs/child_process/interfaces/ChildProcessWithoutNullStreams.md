...
[nodejsscript](../../README.md) / [s](../../nodejsscript/namespaces/s/README.md) / [child\_process](../README.md) / ChildProcessWithoutNullStreams
...
`ChildProcessWithoutNullStreams`.[`channel`](#channel)
...
`ChildProcessWithoutNullStreams`.[`pid`](#pid)
...
`ChildProcessWithoutNullStreams`.[`exitCode`](#exitcode)
...
`ChildProcessWithoutNullStreams`.[`signalCode`](#signalcode)
