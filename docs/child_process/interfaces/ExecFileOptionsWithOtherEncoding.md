...
[nodejsscript](../../README.md) / [s](../../nodejsscript/namespaces/s/README.md) / [child\_process](../README.md) / ExecFileOptionsWithOtherEncoding

# ~~Interface: ExecFileOptionsWithOtherEncoding~~

## Deprecated

Use `ExecFileOptions` instead.
...
[`ExecFileOptions`](ExecFileOptions.md).[`encoding`](ExecFileOptions.md#encoding)
